      ...
      >
        ...
        <div className="relative aspect-[9/16] bg-black rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            ...
            <p className="text-white/70 text-sm">{currentVideo.views} views</p>
          </div>
          ...
          <div
            className="absolute top-0 left-0 w-1/3 h-full md:hidden"
            onClick={(e) => {
              e.stopPropagation();
              goToPrev();
            }}
          />
          <div
            className="absolute top-0 right-0 w-1/3 h-full md:hidden"
            onClick={(e) => {
              e.stopPropagation();
              goToNext();
            }}
